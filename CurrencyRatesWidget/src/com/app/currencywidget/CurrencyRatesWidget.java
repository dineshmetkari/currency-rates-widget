...
public class CurrencyRatesWidget extends AppWidgetProvider {
	...
	public void updateWidget(Context context){
		...
		for (int i = 0; i < currencyRatesList.size(); i++){
			...
			ratesView.setTextViewText(R.id.buyRate, currencyRates.formatRate(buyRate) + ext);
			ratesView.setTextViewText(R.id.sellRate, currencyRates.formatRate(sellRate) + ext); 	
